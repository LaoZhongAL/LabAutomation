...
class MonitorTests(unittest.TestCase):
    ...
    def test_operation_observation_blocks_when_b0_is_set_at_every_sample(self):
        class AllSetSession:
            def __enter__(self):
                return self
        ...
        self.assertEqual(observation["classification"], "set_for_entire_window")
        self.assertEqual(observation["b0_set_count"], 15)
        self.assertEqual(check["status"], "BLOCKED")
        self.assertIn("does not identify FULL ACAL or Autozero", check["message"])
        self.assertFalse(report["live_readiness"]["ready"])
