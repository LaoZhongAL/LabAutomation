...
PROFILE_ID = "keithley-2182a-read-only-v1.5.1"
...
def summarize_2182a_operation_observation(
    ...
    """Decode the fixed v1.5.1 B0 observation without inferring its source."""
...
def _2182a_operation_observation_check(
    ...
    if classification == "clear_for_entire_window":
        ...
        message = (
            ...
            f"{window} s observation window; this does not identify FULL ACAL or Autozero."
        )
    else:
        status = CheckStatus.UNKNOWN
    ...
    return CheckResult(
        ...
        status,
        True,
        "operation-condition B0 clear at every sampled instant",
        observed,
        message,
    )
    ...
    *,
    ...
    if family == "2182a":
        ...
        if operation_observation is not None:
            checks.append(_2182a_operation_observation_check(operation_observation))
        checks.append(
            CheckResult(
