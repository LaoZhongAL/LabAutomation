...
- 2450 参考手册定义 `smu.OFF` 为互锁信号未 asserted，`smu.ON` 为互锁信号 asserted。0.6.0 已修正 0.5.1 界面中的反向解释。
...
0.6.0 新增的 6221/2182A 手动 Pair 界面见 `PAIR_GUI_TUTORIAL_zh.md`。它只在按钮点击时读取，没有自动 VISA 刷新。
