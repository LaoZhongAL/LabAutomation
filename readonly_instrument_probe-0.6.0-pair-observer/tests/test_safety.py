...
class SafetyTests(unittest.TestCase):
    ...
    def test_gui_interprets_model_specific_interlock_semantics(self):
        ...
        self.assertEqual(summary_6221["interlock"], "Closed")
        self.assertNotIn("interlock", " ".join(summary_6221["warnings"]))
        ...
        self.assertEqual(summary_2450["interlock"], "Engaged / asserted")
        self.assertNotIn("interlock", " ".join(summary_2450["warnings"]))

        report_2450["instrument"]["interlock"]["value"] = "smu.OFF"
        summary_2450_open = summarize_report(report_2450)
        self.assertEqual(summary_2450_open["interlock"], "Open / not asserted")
        self.assertIn(
            "2450 interlock signal is not asserted",
            summary_2450_open["warnings"],
        )
